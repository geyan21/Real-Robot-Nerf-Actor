...
from env.robot.objects import MujocoGeneratedObject, PrimitiveObject
from env.robot.utils.mjcf_utils import get_size
...
class CylinderObject(PrimitiveObject):
    ...
    def __init__(
        ...
        size = get_size(size, size_max, size_min, [0.05, 0.05], [0.03, 0.03])
        ...
        solref = [0.02, 1]
        joints = [{"type": "free",   "limited":"false"}]
