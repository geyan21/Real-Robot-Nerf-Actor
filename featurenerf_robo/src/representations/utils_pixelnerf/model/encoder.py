...
import torchvision
import representations.utils_pixelnerf.util as util
from representations.utils_pixelnerf.model.custom_encoder import ConvEncoder
...
class SpatialEncoder(nn.Module):
    ...
    def from_conf(cls, conf):
        return cls(
            ...
            index_interp=conf.index_interp,
            index_padding=conf.index_padding,
            upsample_interp=conf.upsample_interp,
            feature_scale=conf.feature_scale,
            use_first_pool=conf.use_first_pool,
        )
