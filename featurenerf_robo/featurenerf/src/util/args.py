...
# sys.path.insert(
#     0, '/data/geyan21/projects/featurenerf-robo/featurenerf/src'
# )
# sys.path.insert(
#     0, '/data/geyan21/projects/featurenerf-robo/featurenerf/eval'
# )
...
def parse_args(
    ...
    parser.add_argument(
        "--synset", "-S", type=str, default="03001627", help="Synset ID for ShapeNet"
    )
    parser.add_argument(
