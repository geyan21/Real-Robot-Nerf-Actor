...
import agents.nerfinact_bc.utils as utils
from termcolor import colored
from .network_utils import LanguageInformedVisualAttention, VLCrossAttention
...
class ResnetFC(nn.Module):
    def __init__(
        ...
        self.use_language = False # I disable the language in nerf. let us use the language in the voxel
        if self.use_language:
            self.VL3D_transformer = Visual3DLangTransformer(visual_dim=d_latent, lang_dim=d_lang, n_head=6, d_head=64)
            print(colored("[ResnetFC] Using visual-language Cross-attention", "red"))
    ...
    def forward(self, zx, combine_inner_dims=(1,), combine_index=None, dim_size=None, ret_last_feat=False,language_embed=None, batch_size=None):
        ...
        with profiler.record_function("resnetfc_infer"):
            ...
            if self.use_language: # visual-language attention
                ...
                z = self.VL3D_transformer(visual=z, lang=language_embed)
