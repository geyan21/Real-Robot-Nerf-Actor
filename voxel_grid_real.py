    ...
    def __init__(self,
        ...
        self._total_dims_list = torch.cat(
            [torch.tensor([batch_size], ), max_dims,
             torch.tensor([4 + feature_size + self._voxel_rgb_dim], )], -1).tolist()
        ...
        self.register_buffer('_rgb_arange_to_max_coords', torch.arange(4 + feature_size + self._voxel_rgb_dim))
