...
nerf_pnts, nerf_rgbs, nerf_feat = extract_nerf_feat(conf_path, device, model_path, test_image, nerf_npz)
pdb.set_trace()
...
for demo in range(n_demo):
    test_image = os.path.join(position_dir, str(demo)+'_rgb3.png')
    nerf_npz = os.path.join(model_dir, 'Nerfreal_'+str(demo)+'_0.npz')
